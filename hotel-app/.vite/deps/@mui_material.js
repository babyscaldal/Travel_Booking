...
import {
  Transition_default
} from "./chunk-SHVXDH4H.js";
import {
  require_react_dom
} from "./chunk-OTY6O57J.js";
import {
  Box_default
} from "./chunk-YBHE2KMS.js";
import {
  CssVarsProvider,
  ThemeProvider,
  adaptV4Theme,
...
var _excluded4 = ["className", "color", "enableColorOnDark", "position"];
...
true ? AppBar.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types4.default.oneOfType([import_prop_types4.default.oneOf(["default", "inherit", "primary", "secondary", "transparent"]), import_prop_types4.default.string]),
  /**
   * If true, the `color` prop is applied in dark mode.
   * @default false
   */
  enableColorOnDark: import_prop_types4.default.bool,
  /**
   ...
   * @default 'fixed'
   */
  position: import_prop_types4.default.oneOf(["absolute", "fixed", "relative", "static", "sticky"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var Avatar = React13.forwardRef(function Avatar2(inProps, ref) {
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime15.jsx)(AvatarImg, _extends({
      alt,
      src,
      srcSet,
      sizes,
...
var AvatarGroup = React14.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsxs)(AvatarGroupRoot, _extends({
    ...
    children: [extraAvatars ? (0, import_jsx_runtime16.jsxs)(AvatarGroupAvatar, _extends({
      ownerState,
      variant
...
var FormControlLabel = React40.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React40.cloneElement(control, controlProps), required ? (0, import_jsx_runtime49.jsxs)(Stack_default, {
      direction: "row",
      alignItems: "center",
...
var MobileStepper = React56.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime65.jsxs)(MobileStepperRoot, _extends({
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime65.jsxs)(React56.Fragment, {
      ...
      children: [...new Array(steps)].map((_3, index) => (0, import_jsx_runtime66.jsx)(MobileStepperDot, {
...
var Star_default = createSvgIcon((0, import_jsx_runtime81.jsx)("path", {
...
var StarBorder_default = createSvgIcon((0, import_jsx_runtime82.jsx)("path", {
...
function IconContainer(props) {
  ...
  return (0, import_jsx_runtime83.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime83.jsx)(RatingIcon, {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime83.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime84.jsxs)(React73.Fragment, {
    children: [(0, import_jsx_runtime84.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
        emptyValueFocused: void 0
      }),
      htmlFor: id
    }, labelProps, {
      children: [container, (0, import_jsx_runtime83.jsx)("span", {
        className: classes.visuallyHidden,
        children: getLabelText(itemValue)
      })]
    })), (0, import_jsx_runtime83.jsx)("input", {
      className: classes.visuallyHidden,
      onFocus,
      onBlur,
      onChange,
...
var defaultIcon3 = (0, import_jsx_runtime83.jsx)(Star_default, {
  fontSize: "inherit"
});
var defaultEmptyIcon = (0, import_jsx_runtime83.jsx)(StarBorder_default, {
  fontSize: "inherit"
});
...
var Rating = React73.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime84.jsxs)(RatingRoot, _extends({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_3, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime83.jsx)(RatingDecimal, {
          className: clsx_default(classes.decimal, isActive && classes.iconActive),
          ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return (0, import_jsx_runtime83.jsx)(RatingItem, _extends({}, ratingItemProps, {
...
var ScopedCssBaseline = React74.forwardRef(function ScopedCssBaseline2(inProps, ref) {
  ...
  return (0, import_jsx_runtime85.jsx)(ScopedCssBaselineRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
var SpeedDial = React80.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    transitionDuration = defaultTransitionDuration,
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded57), other = _objectWithoutPropertiesLoose(props, _excluded213);
...
var Tooltip = React81.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React81.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime96.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = theme.direction === "rtl";
  ...
  return (0, import_jsx_runtime97.jsxs)(React81.Fragment, {
    children: [React81.cloneElement(children, childrenProps), (0, import_jsx_runtime96.jsx)(PopperComponent, _extends({
...
var Step = React87.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime104.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime103.jsxs)(React87.Fragment, {
...
var StepButton = React92.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React92.cloneElement(children, childProps) : (0, import_jsx_runtime111.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React97.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded69), other = _objectWithoutPropertiesLoose(props, _excluded214);
  ...
  return (0, import_jsx_runtime117.jsxs)(React97.Fragment, {
...
var _FirstPageIcon2;
var _LastPageIcon2;
var _excluded78 = ["backIconButtonProps", "count", "getItemAriaLabel", "nextIconButtonProps", "onPageChange", "page", "rowsPerPage", "showFirstButton", "showLastButton"];
...
var _InputBase;
var _excluded79 = ["ActionsComponent", "backIconButtonProps", "className", "colSpan", "component", "count", "getItemAriaLabel", "labelDisplayedRows", "labelRowsPerPage", "nextIconButtonProps", "onPageChange", "onRowsPerPageChange", "page", "rowsPerPage", "rowsPerPageOptions", "SelectProps", "showFirstButton", "showLastButton"];
