...
var ListItemIcon = React3.forwardRef(function ListItemIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(ListItemIconRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var Skeleton = React6.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(SkeletonRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    ownerState
...
//# sourceMappingURL=chunk-7R67T4A6.js.map
